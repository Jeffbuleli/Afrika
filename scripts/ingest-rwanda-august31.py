#!/usr/bin/env python3
"""Ingest Rwanda August 16-31 REPORT into seed-all.json (EN+FR), varied HD covers."""
...
REPORT = ROOT / "content" / "shinta-august" / "RWANDA_August_31_REPORT.txt"
SEED = ROOT / "content" / "seed-all.json"
COVERS = ROOT / "public" / "covers"
OUT_META = ROOT / "content" / "shinta-august" / "seed-meta-rwanda-august31.json"
MCBULELI_ENV = Path("/Users/mac/Documents/McBuleliP2P/.env")
SOURCE = "RWANDA_August_31_REPORT.txt"
...
FEATURED_HINTS = [
    "Kagame Says FDLR Threat",
    "Rwanda Raises Policy Rate",
    "RwandAir Adds Airbus",
    "AFC/M23 And DRC Agree Roadmap",
    "Joint Verification Team Deploys",
    "Tshisekedi Launches Congo Dialogue",
    "Rwanda Receives 406 Returnees",
    "Parliament Approves Rwf279 Billion",
    "Rwanda Plans Frw330 Billion Irrigation",
    "Bank Of Kigali Courts Chinese",
    "Genocide Convict Wenceslas",
    "DRC Ebola Outbreak Surpasses",
]
...
COVER_QUERIES = [
    ...
    ("fdlr|afc|m23|minembwe|twirwaneho|security|doha|verification", "Virunga mountains Rwanda Congo"),
    ("opoku-agyemang|ghana|mindset reset|mbeki", "Kigali Convention Centre Rwanda"),
    ("rwandair|airbus|a330", "RwandAir aircraft airport"),
    ("policy rate|inflation|central bank|bnr", "Bank of Rwanda Kigali"),
    ("irrigation|nyagatare|onion|maize|seed", "Rwanda agriculture irrigation fields"),
    ("ebola", "Ebola virus Congo health workers PPE"),
    ("returnees|repatriat", "refugees Rwanda border crossing"),
    ("tungsten|mining|musanze", "Rwanda mining landscape hills"),
