#!/usr/bin/env python3
"""Ingest Sudan August 16-31 REPORT into seed-all.json (EN+FR), contextual local covers."""
...
REPORT = ROOT / "content" / "shinta-august" / "SUDAN_August_31_REPORT.txt"
SEED = ROOT / "content" / "seed-all.json"
COVERS = ROOT / "public" / "covers"
OUT_META = ROOT / "content" / "shinta-august" / "seed-meta-sudan-august31.json"
MCBULELI_ENV = Path("/Users/mac/Documents/McBuleliP2P/.env")
SOURCE = "SUDAN_August_31_REPORT.txt"
...
FEATURED_HINTS = [
    "African Union Backs Sudan Dialogue",
    "US Pushes UN To Expand Sudan Arms Embargo",
    "Sudan Forms Crisis Cell As Pound Hits Record Low",
    "Central Bank Reviews FX Interventions",
    "Darfur Gold Smuggling Network",
    "RSF Claims Capture Of Key Army Bases In Blue Nile",
    "Kordofan Fighting Drives Displacement Above 200,000",
    "Chad Accuses Sudanese Forces Of Drone Strike",
    "Sudanese Plaintiffs Prepare US Civil Case Against UAE",
    "SPLM-N Retakes Kauda",
    "Army Says It Downed RSF Drones",
    "Hamdok Urges Unified Civilian Front",
]
