#!/usr/bin/env python3
"""Ingest Uganda August 1-15 REPORT into seed-all.json (EN+FR), contextual local covers."""
...
REPORT = ROOT / "content" / "shinta-august" / "UGANDA_August_15_REPORT.txt"
SEED = ROOT / "content" / "seed-all.json"
COVERS = ROOT / "public" / "covers"
OUT_META = ROOT / "content" / "shinta-august" / "seed-meta-uganda-august15.json"
MCBULELI_ENV = Path("/Users/mac/Documents/McBuleliP2P/.env")
SOURCE = "UGANDA_August_15_REPORT.txt"
...
FEATURED_HINTS = [
    "Cabinet Picks Face Citizenship",
    "Museveni Presses NRM",
    "Manufacturing Share",
    "Bank of Uganda",
    "EACOP",
    "Law Society Warns",
